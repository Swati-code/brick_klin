...
<body>
	<div class="container">
		<h1 class="text-center mt-5">HSN Master</h1>
			...
			<div class="col-6 offset-3">
				<form id="hsn">
					...
					<div class="form-group">
				        ...
				        <input type="text" name="hsn_code" class="form-control" placeholder="">
					</div>				
		...
		<div class="row">
			<div class="col">
				<table id="hsncode" class="table table-bordered">
					<thead>
						<tr>
							<th>id</th>
							<th>HSN Code</th>
			...
			$(document).on('click','#edit',function(){
				...
				$.ajax({
					...
					success:function(response){
						...
						$('input[name="edit_hsn"]').val(response.data.hsn_code);
					}
				});
			})  
			//Update Code is here
